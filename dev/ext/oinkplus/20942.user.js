...
// @include 	  *acid-lounge.org.uk/details.php*
...
what:	{	
  ...
  kraytracker:	{	
	...
	acidlounge:	{	
				name:	"Acid-Lounge", 
				url:	{		0: "acid-lounge.org.uk/details.php",
	...
	function addWidgets(artist){
		 ...
		 /* 
			...
			*/
			...
			wMSPPlayer.scraperImpl = function () {
					var mspPlayerCode = this._content.extract("new SWFObject(\"", "\"shell\"");
					if (mspPlayerCode != ''){
						//disableAutoplay
						...
						var movieUrl = mspPlayerCode.extractInner("SWFObject(\"", "\"");
