...
function setBackend(){
	if ((document.setup7.backend1.value == "database") && (document.setup7.backend2.value == "filesystem")){
		document.setup7.backend.value = "database";
		document.setup7.readTags.disabled = false;
	}
	if ((document.setup7.backend1.value == "database") && (document.setup7.backend2.value == "id3")){
		document.setup7.backend.value = "id3-database";
		document.setup7.readTags.disabled = true;
	}
	if ((document.setup7.backend1.value == "cache") && (document.setup7.backend2.value == "filesystem")){
		document.setup7.backend.value = "cache";
		document.setup7.readTags.disabled = false;
	}
	if ((document.setup7.backend1.value == "cache") && (document.setup7.backend2.value == "id3")){
		document.setup7.backend.value = "id3-cache";
		document.setup7.readTags.disabled = true;
	}
}
...
<div id="main">
	...
	<form action="<?php echo $form_action; ?>" name="setup7" method="post">
		...
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
			...
			?>
			<tr>
				<td class="td" width="40%" align="left" valign="top" colspan="3">
					<br />
				</td>
			</tr>
			<tr>
				...
				<td class="td" width="1">&nbsp;</td>
				<td class="td" width="60%" align="left">
					<select onChange="setBackend();" name="backend1" style="width:125;" onmouseover="return overlib('<?php echo $word_backend1_note; ?>', FGCOLOR, '#eeeeeee');" onmouseout="return nd();">
						<option value="database"><?php echo $word_database; ?></option>
		...
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
			<tr>
				...
				<td class="td" width="1">&nbsp;</td>
				<td class="td" width="60%" align="left">
					<select onChange="setBackend();document.setup7.nextbutton.disabled=false;" name="backend2" style="width:125;" onmouseover="return overlib('<?php echo $word_backend2_note; ?>', FGCOLOR, '#eeeeeee');" onmouseout="return nd();">
						<option value=""> - </option>
						<option value="filesystem"><?php echo $word_filesystem; ?></option>
						<option value="id3"><?php echo $word_id3; ?></option>
					</select>
					...
					<input type="hidden" name="backend" value="database">
				</td>
			</tr>		
			<tr>
				<td class="td" width="40%" align="left" valign="top">
